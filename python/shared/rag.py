...
- If the answer includes multi-step processes, concept comparisons, category/status breakdowns, or learning/explanatory material, prefer a rich action label that invites color expansion.
- Example rich labels: "Add more colors to this explanation 🎨" / "Create more colorful version … 🎨" (or Polish equivalent), still respecting all other button rules.
