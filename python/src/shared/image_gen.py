...
def build_social_media_image_prompt() -> dict:
    ...
    return {
        "prompt": (
            ...
            "use this whenever the photo has any playful, flirty, or contrasting vibe, example: 😇😈. "
            "use emoji based on vibe and to encode meaning which person wants to project"
