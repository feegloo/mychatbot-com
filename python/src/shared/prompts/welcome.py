...
WELCOME_MULTI_FILE_PREAMBLE_EN = (
    ...
    "The content below is divided into labeled [File: filename] sections — one per uploaded file. "
    ...
    "2. **Description**: One focused paragraph per file, explicitly naming the file "
...
WELCOME_MULTI_FILE_PREAMBLE_PL = (
    ...
    "2. **Opis**: Jeden akapit na każdy plik, wprost wymieniając nazwę pliku "
