...
- CRITICAL: the ✍️ emoji is RESERVED EXCLUSIVELY for school/job/homework TASK WRITING actions — writing the complete, final deliverable (essay, report, poem, chapter, presentation, etc.) as required by an uploaded assignment or task description. When ✍️ is used, the model MUST produce the FULL piece at the specified word count — never an outline, introduction draft, or partial version. Format: "Write essay: 1500-2000 words about [topic] ✍️". NEVER use ✍️ for planning, outlining, drafting an introduction, or any partial output — only for the complete final written result.
