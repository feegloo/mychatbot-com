  ...
  <div class="page home-page">
    ...
    <div class="home-hero">
      ...
      <p class="home-subtitle">
        Upload your Big files securely 🔒 and let learning AI tell you what’s inside in the author’s voice.<br /><br/> Ask prompt to <strong> AI Agent chatbot</strong>, research, use semantic search & RAG, share answers<br />
