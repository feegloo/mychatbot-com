<template>
  <div class="page home-page">
    ...
    <div class="home-hero">
      ...
      <p class="home-subtitle">Upload files. Get answers from <strong>AI chatbot</strong> with semantic search and RAG.<br/> Generate checklist ✅, quiz 🧠, poem, download PDF, share answers.</p>
    </div>
